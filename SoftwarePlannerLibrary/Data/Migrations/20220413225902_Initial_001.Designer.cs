...
namespace SoftwarePlannerLibrary.Data.Migrations
{
    ...
    [Migration("20220413225902_Initial_001")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectModelUserModel", b =>
                {
                    ...
                    b.HasKey("ProjectModelsId", "UsersId");
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.AlertModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.PriorityModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.StatusModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.TypeModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.AlertModel", b =>
                {
                    ...
                    b.HasOne("SoftwarePlannerLibrary.Models.NoteModel", "Note")
                        .WithMany("Alerts")
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.ChangeModel", b =>
                {
                    ...
                    b.HasOne("SoftwarePlannerLibrary.Models.TicketModel", "TicketModel")
                        .WithMany()
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.FileModel", b =>
                {
                    b.HasOne("SoftwarePlannerLibrary.Models.CreatorModel", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.NoteModel", b =>
                {
                    ...
                    b.HasOne("SoftwarePlannerLibrary.Models.PriorityModel", "PriorityModel")
                        .WithMany()
                    ...
                    b.HasOne("SoftwarePlannerLibrary.Models.StatusModel", "StatusModel")
                        .WithMany()
                    ...
                    b.HasOne("SoftwarePlannerLibrary.Models.TypeModel", "TypeModel")
                        .WithMany()
            ...
            modelBuilder.Entity("SoftwarePlannerLibrary.Models.ProjectModel", b =>
                {
                    b.HasOne("SoftwarePlannerLibrary.Models.ChangeModel", "ChangeModel")
                        .WithMany()
                    ...
                    b.HasOne("SoftwarePlannerLibrary.Models.FileModel", "Photo")
                        .WithMany()
