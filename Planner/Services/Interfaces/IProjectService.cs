...
namespace Planner.Services.Interfaces
{
    public interface IProjectService
    {
        ...
        public Task<List<Project>> GetAllProjectsByTeam(int TeamId);
        public Task<List<Project>> GetAllProjectsByPriority(int TeamId, string priorityName);
        public Task<List<AppUser>> GetAllProjectMembersExceptPMAsync(int projectId);
        public Task<List<Project>> GetArchivedProjectsByTeam(int TeamId);
        ...
        public Task<Project> GetProjectByIdAsync(int projectId, int TeamId);
        public Task<List<AppUser>> GetSubmittersOnProjectAsync(int projectId);
        public Task<List<AppUser>> GetUsersNotOnProjectAsync(int projectId, int TeamId);
