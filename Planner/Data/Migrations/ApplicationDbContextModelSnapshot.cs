...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectAppUser", b =>
                {
            ...
            modelBuilder.Entity("Planner.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Planner.Models.ProjectPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Planner.Models.TicketAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Planner.Models.TicketPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Planner.Models.TicketStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Planner.Models.TicketType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ProjectAppUser", b =>
                {
                    b.HasOne("Planner.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("MembersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Planner.Models.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Planner.Models.Invite", b =>
                {
                    ...
                    b.HasOne("Planner.Models.AppUser", "Invitee")
                        .WithMany()
                        .HasForeignKey("InviteeId");

                    b.HasOne("Planner.Models.AppUser", "Invitor")
                        .WithMany()
            ...
            modelBuilder.Entity("Planner.Models.Notification", b =>
                {
                    b.HasOne("Planner.Models.AppUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Planner.Models.AppUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Planner.Models.Project", b =>
                {
                    b.HasOne("Planner.Models.ProjectPriority", "Priority")
                        .WithMany()
            ...
            modelBuilder.Entity("Planner.Models.Ticket", b =>
                {
                    b.HasOne("Planner.Models.AppUser", "DeveloperUser")
                        .WithMany()
                        .HasForeignKey("DeveloperUserId");

                    b.HasOne("Planner.Models.AppUser", "OwnerUser")
                        .WithMany()
                    ...
                    b.HasOne("Planner.Models.TicketPriority", "TicketPriority")
                        .WithMany()
                        .HasForeignKey("TicketPriorityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Planner.Models.TicketStatus", "TicketStatus")
                        .WithMany()
                        .HasForeignKey("TicketStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Planner.Models.TicketType", "TicketType")
                        .WithMany()
            ...
            modelBuilder.Entity("Planner.Models.TicketAttachment", b =>
                {
                    ...
                    b.HasOne("Planner.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
