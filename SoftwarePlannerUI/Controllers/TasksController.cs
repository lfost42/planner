...
namespace SoftwarePlannerUI.Controllers
{
    public class TasksController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Tasks.Include(t => t.Creator).Include(t => t.Photo).Include(t => t.PriorityModel).Include(t => t.StatusModel);
        ...
        public async Task<IActionResult> Create([Bind("Id,TaskName,Description,CreatorId,DateCreated,DueDate,ClosedDate,PriorityModelId,StatusModelId,Archived,AssignedUserlId,TeamModelId,PhotoId")] TaskModel taskModel)
        {
            ...
            ViewData["CreatorId"] = new SelectList(_context.Set<CreatorModel>(), "Id", "Id", taskModel.CreatorId);
