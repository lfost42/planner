...
namespace SoftwarePlannerUI.Controllers
{
    public class NotesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Notes.Include(n => n.CreatorModel).Include(n => n.PriorityModel).Include(n => n.ProjectModel).Include(n => n.RequirementModel).Include(n => n.StatusModel).Include(n => n.TaskModel).Include(n => n.TicketModel).Include(n => n.TypeModel);
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,DateCreated,CreatorModelId,ProjectModelId,RequirementModelId,TaskModelId,TicketModelId,TypeModelId,PriorityModelId,StatusModelId,Archived,AssignedUserlId,TeamModelId")] NoteModel noteModel)
        {
            ...
            ViewData["CreatorModelId"] = new SelectList(_context.Set<CreatorModel>(), "Id", "Id", noteModel.CreatorModelId);
