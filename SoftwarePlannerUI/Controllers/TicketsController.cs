...
namespace SoftwarePlannerUI.Controllers
{
    public class TicketsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Tickets.Include(t => t.CreatorModel).Include(t => t.PriorityModel).Include(t => t.ProjectModel).Include(t => t.StatusModel).Include(t => t.TaskModel).Include(t => t.TeamModel).Include(t => t.TypeModel);
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketName,TicketDescription,DateCreated,DueDate,ClosedDate,CreatorModelId,ProjectModelId,TaskModelId,TypeModelId,PriorityModelId,StatusModelId,Archived,AssignedUserlId,TeamModelId")] TicketModel ticketModel)
        {
            ...
            ViewData["CreatorModelId"] = new SelectList(_context.Set<CreatorModel>(), "Id", "Id", ticketModel.CreatorModelId);
